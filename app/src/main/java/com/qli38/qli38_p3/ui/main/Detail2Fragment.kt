...
class Detail2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.blueAnswerDetail2.setOnClickListener {
            score = 1
            it.findNavController().navigate(R.id.action_detail2Fragment_to_detail3Fragment)
        }

        binding.redAnswerDetail2.setOnClickListener {
